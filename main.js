...
const createScene = () => {
    ...
    const flowerPot = BABYLON.SceneLoader.ImportMesh(null, "https://aditya-patwa.github.io/Realistic-3d-Room/assets/models/flowerpot/", "scene.gltf", scene, function (meshes) { 
